...
const GameStats: React.FC<GameStatsProps> = ({
	...
	<div
		className={`game-stats relative bg-whiteFrost dark:bg-gray-700 py-5 w-[90%] max-w-[22em] mx-auto text-xl font-light md:text-2xl border font-gothic rounded-sm ${
			weHookedThem
