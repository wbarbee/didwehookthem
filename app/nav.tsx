...
const Nav = () => {
	...
	return (
		<nav className='absolute top-0 nav-main ml-3 md:ml-4 mt-4 max-w-[26rem] md:max-w-[27rem] w-full animate-fade-in'>
			<button
				onClick={toggleMenu}
			...
			{isMenuOpen && (
				<div className='dropdown-wrapper relative ml-4 max-w-[95%] md:max-w-[19.5rem] w-full'>
					...
					<div className='absolute -left-[1rem] md:left-1 bg-gray-300 dark:bg-gray-800 shadow-lg rounded-md w-full z-10 pt-4 pb-2 px-1 md:px-2 mt-4 transition-all ease-in-out duration-400 max-w-[18rem] md:max-w-full'>
